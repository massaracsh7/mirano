                                  ...
                                  <ul className="goods__list">
                                      ...
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          ...
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">6700&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          <h3 className="card__title">Букет из роз Grand Avalanche (101 шт)
                                          </h3>
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">14800&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          <h3 className="card__title">Букет из роз Grand Vanilla Cream (101
                                            шт)</h3>
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">19800&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          <h3 className="card__title">Букет из роз Grand Mirabel (101 шт)
                                          </h3>
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">21300&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          ...
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">14200&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          ...
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">13600&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          <h3 className="card__title">Авторский букет из роз, диантусов и
                                            сухоцветов</h3>
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">3000&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          <h3 className="card__title">Авторский букет из роз, герберов,
                                            диантусов и сухоцветов</h3>
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">2000&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          <h3 className="card__title">Авторский букет из роз и сухоцветов
                                          </h3>
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">2200&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          ...
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">1600&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          <h3 className="card__title">Авторский букет из роз и диантусов
                                          </h3>
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">2700&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          ...
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">1500&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          ...
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">3400&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          ...
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">2900&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          ...
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">2500&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          <h3 className="card__title">Цветы в корзине с разноцветными
                                            ранункулюсами</h3>
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">3800&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          ...
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">1700&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          <h3 className="card__title">Цветы в коробке из гербер и ирисов
                                          </h3>
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">3200&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          <h3 className="card__title">Цветы в корзине с миксом весенних
                                            цветов</h3>
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">3600&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          ...
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">1400&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          <h3 className="card__title">Авторский букет из гладиолусов и
                                            альстромерий</h3>
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">3100&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                    ...
                                    <li className="goods__item">
                                      <article className="goods__card card"><img className="card__image"
                                        ...
                                        <div className="card__content">
                                          <h3 className="card__title">Цветы в коробке с суккулентами и
                                            каллами</h3>
                                          <div className="card__footer">
                                            <p className="card__date-delivery">сегодня в 14:00</p><button
                                              className="card__button">3700&nbsp;₽</button>
                                          </div>
                                        </div>
                                      </article>
                                    </li>
                                          ...
                                          <div className="order__input-group"><input className="order__input"
                                            ...
                                            <fieldset className="order__fieldset">
                                              <div className="order__payment"><label className="order__label-radio"><input
                                                ...
                                                value="true" checked="true" />Оплата онлайн</label></div>
